...
phrase = [
    "Зеленыш: Так, я что то не понял! Быстренько прописал /start этому лошку!",
    "Тетя Зина: МА А! Мою защиту не пробить! Попытайся конечно, если у тебя получится после моего..."
]
