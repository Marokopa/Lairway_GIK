...
SM.New("LairWay",["en","ru"],['Welcome to Lairway Text-TB Engine. \nDevelopers: Catman (great and main), whymyyanemogyispolzovstsvoinic (assistant) \n Communication - LairWayBot @gmail. com \n\nLairway version - /SEA/\nYour role - /SEA/\nusers of this bot - /SEA/\nHave a good game! Welcome to Lairway Text-TB Engine. \nDevelopers: Catman (great and main), whymyyanemogyispolzovstsvoinic (assistant) \n Communication - LairWayBot @gmail. com \n\nLairway version - /SEA/\nYour role - /SEA/\nusers of this bot - /SEA/\nHave a good game!','Добро пожаловать в Lairway Текстовый-TB Движек. \nРазработчики: Catman (великий и главный), pochemyyanemogyispolzovstsvoinic (помощник) \n Связь - LairWayBot @gmail. com \n\nВерсия Lairway — /SEA/\nВаша роль — /SEA/\nпользователи этого бота — /SEA/\nУдачной игры!'])

SM.New('LW', ['en', 'ru'], ["Created using LairWay. Good game!\n","Создано при использововании LairWay. Удачной игры!\n "])
SM.New('Read', ['en', 'ru'], ["The file was read and processed again.","Файл был заново прочитан и обработан."])
...
SM.New("door_er",["en","ru"],['An error has occurred. You may have used the wrong syntax. \n door var how \n. It also reminds us that gaps in the original syntax are replaced by “~”', 'Произошла ошибка. Возможно вы использовали неправильный синтаксис. \n door var how \n. Так же напоминает что проблеы в оригинальном синтаксисе заменяються на "~"'])
...
SM.New('del_er3', ['en', 'ru'], ['Error. \nYou may have entered a nickname for a non-existent variable', 'Error.  \n Возможно вы ввели ник несуществующий переменной'])
SM.New('Remove', ['en', 'ru'], ["The element was deleted successfully", "Удаление элемента прошло успешно"])
SM.New('Upd', ['en', 'ru'], ["Обновление произошло успешно!", "The update was successful!"])
SM.New('UpdError', ['en', 'ru'], ["Во время обновления произошла ошибка", "An error occurred during the update"])
SM.New('RemoveError', ['en', 'ru'], ["There was some problem deleting the item.", "При удалении элемента произошла какая-то проблема."])
SM.New('NoLWLS', ['en', 'ru'], ["You don't have an LWLS module", "У вас нет модуля LWLS."])
