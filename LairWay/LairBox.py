...
def AddFotoId(uid,foto): cur.execute("UPDATE UsInf SET fotoid = ? WHERE id = ?", 
...
def MulBox(uid,box,key):cur.execute("UPDATE box SET key = ? WHERE (id,box) = (?,?)",(Box(uid,box)*key,uid,box))
def DivBox(uid,box,key): cur.execute("UPDATE box SET key = ? WHERE (id,box) = (?,?)",(Box(uid,box)//key,uid,box))
def MivBox(uid,box,key): cur.execute("UPDATE box SET key = ? WHERE (id,box) = (?,?)", (Box(uid,box)//key,uid,box))
def ModBox(uid,box,key): cur.execute("UPDATE box SET key = ? WHERE (id,box) = (?,?)",(Box(uid,box)%key,uid,box))
def PowBox(uid,box,key): cur.execute("UPDATE box SET key = ? WHERE (id,box) = (?,?)",(Box(uid,box)**key,uid,box))
